...
export default function BuildersPage() {
  return (
    <>
      ...
      <section className="mkt-wrap" style={{ background: BG }}>
        <div style={inner}>
          ...
          <div className="mkt-split" style={{ gap: 28 }}>
            {/* WITHOUT */}
            <div style={{ borderRadius: 12, padding: 36, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.08)" }}>
            ...
            {/* WITH */}
            <div style={{ borderRadius: 12, padding: 36, background: "rgba(176,77,255,0.05)", border: "1px solid rgba(176,77,255,0.28)" }}>
        ...
        <div style={inner}>
          ...
          <div className="mkt-g3" style={{ gap: 20 }}>
            {[
              ...
              <div key={c.t} style={{ borderRadius: 12, padding: 28, background: "rgba(176,77,255,0.04)", border: "1px solid rgba(176,77,255,0.18)", display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      {/* AI ERA */}
      <section className="mkt-wrap" style={{ background: "rgba(176,77,255,0.02)", borderTop: "1px solid rgba(176,77,255,0.1)", borderBottom: "1px solid rgba(176,77,255,0.1)" }}>
        <div style={inner}>
          ...
          <div className="mkt-g3" style={{ gap: 20 }}>
            {[
              ...
              <div key={c.t} style={{ borderRadius: 12, padding: 32, background: BG2, border: `1px solid ${BORDER}` }}>
      ...
      {/* PRICING */}
      <section className="mkt-wrap" style={{ background: BG2, borderTop: `1px solid ${BORDER_L}`, borderBottom: `1px solid ${BORDER_L}` }} id="pricing">
        <div style={inner}>
          ...
          <div className="mkt-g4" style={{ gap: 16 }}>
            {[
              ...
              <div key={c.tier} style={{ borderRadius: 12, padding: 28, display: "flex", flexDirection: "column", gap: 12, background: c.featured ? "rgba(176,77,255,0.06)" : BG, border: c.featured ? "1.5px solid rgba(176,77,255,0.35)" : `1px solid ${BORDER}` }}>
      ...
      {/* FINAL CTA */}
      <section className="mkt-wrap" style={{ background: "rgba(176,77,255,0.03)", borderTop: "1px solid rgba(176,77,255,0.12)", textAlign: "center" }} id="getstarted">
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          <Link href="/getstarted" className="mkt-btn-tint" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "16px 36px", borderRadius: 12, fontSize: 16, fontWeight: 600, textDecoration: "none", background: "rgba(176,77,255,0.12)", color: PURPLE, border: "1.5px solid rgba(176,77,255,0.4)" }}>
            Apply for Access →
          </Link>
        </div>
      </section>
